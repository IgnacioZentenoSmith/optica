...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:8000","http://localhost:3000", "http://34.66.54.250"
]
...
# NEW
SIMPLE_JWT = {
  'ACCESS_TOKEN_LIFETIME': timedelta(minutes=60), # timedelta(minutes=60),
  'REFRESH_TOKEN_LIFETIME': timedelta(minutes=720), # timedelta(minutes=12*60),
